...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		array(
			'header' => 'Preview',
			'type' => 'raw',
			'value' => 'CHtml::image(Utils::imageUrl("../paintings/flux".DS.$data->thumb), $data->title, array("width"=>45))',
		),
		'title',
	        array(
	            'name' => 'in_app',
	            'value' => 'Painting::getTypeText($data->in_app)',
	            'filter'=> Painting::getType(),
	        ),
		array(
			'name' => 'date_created',
		...
		array(
			...
			'buttons' => array(
				'publish' => array(
					'label'=>'Unpublished',
					'url'=>'array("cms/painting/publish", "id"=>$data->id)',
				...
				'unpublish' => array(
					'label'=>'Published',
					'url'=>'array("cms/painting/unpublish", "id"=>$data->id)',
					...
					'click'=>'js:function(){
						...
						$("#image-grid").yiiGridView("update", {
							...
							url: $(this).attr("href"),
							success: function(data) {
								$("#painting-grid").yiiGridView("update");
								afterDelete(th, true, data);
							},
							error: function(XHR) {
								return afterDelete(th, false, XHR);
...
echo CHtml::link('Add painting', array('cms/painting/create'), array('class'=>'button'));